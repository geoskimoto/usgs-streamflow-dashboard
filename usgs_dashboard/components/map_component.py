...
PERCENTILE_GROUP_CONFIG = [
    ...
    ('p76_85',  '75th – 85th percentile',  '#1565C0', 0.92, 1.15),
    ('p86_90',  '85th – 90th percentile',  '#0D47A1', 0.93, 1.20),
    ('p91_95',  '90th – 95th percentile',  '#0A3585', 0.93, 1.25),
    ('p96_98',  '95th – 98th percentile',  '#07256B', 0.94, 1.30),
